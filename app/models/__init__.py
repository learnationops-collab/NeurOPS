...
from .training_video import TrainingVideo, TrainingVideoQuestion, TrainingVideoOption, TrainingVideoCompletion
...
__all__ = [
    ...
    'TrainingVideo', 'TrainingVideoQuestion', 'TrainingVideoOption', 'TrainingVideoCompletion'
]

                ...
                <div className="p-6 md:p-8 border-b border-base/50 flex justify-between items-center bg-surface/50 shrink-0 relative pr-16">
                    <div className="space-y-1">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-2xl md:text-3xl font-black text-base italic uppercase tracking-tighter">Nueva Agenda</h2>
                        </div>
                ...
                <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0 overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8 space-y-6 min-h-0">
                        {step === 1 ? (
                            ...
                            <div className="space-y-6">
                                {isNewClient && (
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-bottom-4 pb-4 border-b border-base/50">
                                        ...
                                        <div className="col-span-1 space-y-2">
                                            <label className="text-[10px] font-black text-muted uppercase tracking-widest ml-1 flex items-center gap-1.5"><Instagram size={12} /> Instagram</label>
                                            <input
                                                required
                                                className="w-full px-5 py-3 bg-main border border-base rounded-xl text-sm outline-none focus:ring-2 focus:ring-primary/50 transition-all font-bold"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            className="w-full px-5 py-3 bg-main border border-base rounded-xl text-sm outline-none focus:ring-2 focus:ring-primary/50 transition-all font-bold cursor-pointer"
                    ...
                    {/* Footer Fijo */}
                    {step === 2 && (
                        <div className="p-6 border-t border-base bg-surface/50 shrink-0 flex gap-4">
                            <Button
                                type="button"
                                variant="ghost"
                                onClick={() => setStep(1)}
                                className="px-6 text-xs font-black tracking-widest uppercase"
                            >
                                Atrás
                            </Button>
                            <Button
                                ...
                                loading={submitting}
                                variant="primary"
                                className="flex-1 text-xs font-black tracking-widest uppercase"
                                icon={CheckCircle2}
                            >
                                Confirmar Agenda
                            </Button>

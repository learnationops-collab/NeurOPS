...
const SetterDeckPage = () => {
    ...
    const fetchComments = async (apptId) => {
        ...
        try {
            const res = await api.get(`/setter/deck/comments/${apptId}`);
    ...
    const handleSendComment = async (e) => {
        ...
        try {
            ...
            await api.post(`/setter/deck/comments/${activeCard.id}`, payload);
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                            ...
                            <div className="space-y-6">
                                ...
                                {/* Sección de Comentarios e Intercambio de Leads */}
                                {activeCard && (

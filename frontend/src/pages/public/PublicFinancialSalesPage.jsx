...
const PublicFinancialSalesPage = () => {
    ...
    // La confirmacion y la ventana de deshacer las hace el propio boton (InlineConfirm): un
    // `window.confirm` lo dibuja el navegador, se puede bloquear, y entonces el boton no hace
    // nada sin ninguna senal.
                                                ...
                                                {isEditing ? (
                                                    ...
                                                    <div className="flex items-center justify-center gap-2">
                                                        ...
                                                        <InlineConfirm
                                                            ...
                                                            question="¿Ocultar?"
                                                            doneLabel="Oculta"
                                                            title="Eliminar la venta (se oculta acá, sigue en Google Sheets)"

...
import { Check, Clock, X, UserX, FlaskConical } from 'lucide-react';

const VOTO_TOAST = {
    pre: { label: 'Seleccionado', color: '#34d399', bg: 'rgba(52,211,153,.15)', Icon: Check },
    ...
    testeo: { label: 'En testeo', color: '#38bdf8', bg: 'rgba(56,189,248,.15)', Icon: FlaskConical },
...
const PostulacionVoteToast = ({ toast, onDone }) => {
    ...
    return (
        <div
            className="fixed left-1/2 top-1/2 z-[310] w-[420px] max-w-[90vw] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-3xl border border-white/15 bg-[#141a3a] shadow-2xl transition-all duration-200"
